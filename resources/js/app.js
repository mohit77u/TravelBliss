...
$(function(){
    if($('.custom-dropdown').length){
        ...
        // handle click dropdown item to get city and close dropdown menu
        ...
        $('html').on('click', function(event){
            ...
            var dropdownBtn = offsetParent.classList.contains('custom-dropdown-btn')
            var dropdownMain = offsetParent.classList.contains('custom-dropdown')
            if(!dropdownBtn && !dropdownMain && dropdown.hasClass('show')){
                dropdown.removeClass('show')
