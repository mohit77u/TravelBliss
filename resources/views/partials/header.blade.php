                    ...
                    <div class="menu hidden lg:block">
                        <ul class="flex items-center lg:space-x-3">
                            ...
                            @else
                                text-gray-500
                            @endif 
                            hover:text-gray-800 text-md px-3 whitespace-nowrap">Home</a></li>
                            ...
                            @else
                                text-gray-500
                            @endif
                             hover:text-gray-800 text-md px-3 whitespace-nowrap">About</a></li>
                            ...
                            @else
                                text-gray-500
                            @endif
                             hover:text-gray-800 text-md px-3 whitespace-nowrap">Destinations</a></li>
                             <li><a href="{{ route('destinations.get') }}" class="
                            @if (request()->route()->named('packages.get'))
                                text-emerald-400
                            @else
                                text-gray-500
                            @endif
                             hover:text-gray-800 text-md px-3 whitespace-nowrap">Packages</a></li>
                            ...
                            @else
                                text-gray-500
                            @endif
                             hover:text-gray-800 text-md px-3 whitespace-nowrap">Gallery</a></li>
                            ...
                            @else
                                text-gray-500
                            @endif
                             hover:text-gray-800 text-md px-3 whitespace-nowrap">News</a></li>
                            ...
                            @else
                                text-gray-500
                            @endif
                             hover:text-gray-800 text-md px-3 whitespace-nowrap">Contact us</a></li>
                            <li>
                                <a href="#" class="hoverwhitebtn whitespace-nowrap bg-emerald-400 text-white px-5 py-2 xl:ml-6 lg:ml-2 inline-block border border-transparent hover:border-emerald-400"><span>Book Now</span></a>
                            </li>
                        </ul>
                    </div>
