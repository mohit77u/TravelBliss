        ...
        <div class="form">
            ...
            <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-3 mb-3">
                ...
                <div class="form-group">
                    <div class="custom-dropdown relative">
                        ...
                        <input type="text" class="field hidden" name="state"> 
                ...
                <div class="form-group">
                    <div class="custom-dropdown relative">
                        ...
                        <input type="text" class="field hidden" name="city">
            ...
            <div class="form-group mb-3">
                <div class="image-upload">
                    ...
                    <input type="file" class="xl:w-1/3 lg:w-7/12 w-full bg-emerald-50/25 text-slate-800 py-2 px-2 border border-gray-200 focus:ring-0 focus:border-emerald-400 focus:outline-none" name="featured_image">
                </div>
                <!-- for preview purpose -->
            ...
            <div class="form-group mb-3">
                <div class="image-upload">
                    ...
                    <input type="file" class="xl:w-1/3 lg:w-7/12 w-full bg-emerald-50/25 text-slate-800 py-2 px-2 border border-gray-200 focus:ring-0 focus:border-emerald-400 focus:outline-none" multiple name="images[]">
                </div>
                <!-- for preview purpose -->
                <div class="my-5 hidden">
                    <div class="grid lg:grid-cols-6 md:grid-cols-3 grid-cols-1 gap-4 image-container">
    ...
    <div class="bg-white p-6 rounded xl:col-span-2">
        ...
        <div class="form-group mb-3 destination-features">
            ...
            <div class="features-form flex items-center justify-between gap-2 mb-3">
                <input class="w-full bg-emerald-50/25 text-slate-800 py-2 px-2 border border-gray-200 focus:ring-0 focus:border-emerald-400 focus:outline-none" placeholder="Features" name="features[]">
