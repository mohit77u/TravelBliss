<nav class="sidebar md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:overflow-x-hidden md:flex-row md:flex-nowrap bg-white flex flex-wrap items-center justify-between relative md:w-64 z-10 border-r md:border-slate-100">
    <div class="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
        ...
        <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden py-10" id="mobile-menu">
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none main-sidebar-menu">
                <!-- label heading -->
                <h3 class="pb-1 border-b border-slate-100 text-slate-400 font-medium px-4">Navigations</h3>
                <li class="items-center main-item">
                    <a href="{{ route('dashboard.get')}}" class="group text-[14px] whitespace-nowrap capitalize py-3 px-4 flex w-full items-center text-slate-700 hover:bg-emerald-400 hover:text-white font-monteserrat font-medium @if(request()->route()->named('dashboard.get')) active @endif">
                ...
                <li class="items-center dropdown main-item">
                    <button class="group text-[14px] flex w-full justify-between items-center menu whitespace-nowrap capitalize py-3 hover:bg-emerald-400 hover:text-white px-4 text-slate-700 font-monteserrat font-medium" type="button" data-dropdown-toggle="gallery">
                    ...
                    <div class="dropdown-menu hidden" id="gallery">
                        <ul>
                            <li><a class="sub-menu block w-full text-[13px] font-monteserrat capitalize py-2 px-12 text-slate-800 font-medium" href="#">Add New</a></li>
                            <li><a class="sub-menu block w-full text-[13px] font-monteserrat capitalize py-2 px-12 text-slate-800 font-medium" href="#">All Gallery</a></li>
                        </ul>
                    </div>
                </li>
                <li class="items-center main-item">
                    <a href="{{ route('admin.destinations.create')}}" class="group text-[14px] whitespace-nowrap capitalize py-3 px-4 flex w-full items-center hover:bg-emerald-400 hover:text-white text-slate-700 font-monteserrat font-medium @if(request()->is('admin/destination*')) active @endif">
                ...
                <li class="items-center main-item">
                    <a href="" class="group text-[14px] whitespace-nowrap capitalize py-3 px-4 flex w-full items-center hover:bg-emerald-400 hover:text-white text-slate-700 font-monteserrat font-medium @if(request()->route()->named('admin.dashboard')) active @endif">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-slate-300 group-hover:text-white mr-3">
                ...
                <!-- label heading -->
                <h3 class="mt-5 pb-1 border-b border-slate-100 text-slate-400 font-medium px-4">Meta Tags</h3>
                <li class="items-center main-item">
                    <a href="" class="group text-[14px] whitespace-nowrap capitalize py-3 px-4 flex w-full items-center hover:bg-emerald-400 hover:text-white text-slate-700 font-monteserrat font-medium @if(request()->route()->named('admin.dashboard')) active @endif">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-slate-300 group-hover:text-white mr-3">
